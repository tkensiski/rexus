...
# time to sleep between the readings. Number of seconds to sleep between each measurement
zeit = 5

# sleep shows how frequently each channel is read in over the I2C bus. Best to use
# sleep between each successive readings. number of seconds to sleep between each channel reading
